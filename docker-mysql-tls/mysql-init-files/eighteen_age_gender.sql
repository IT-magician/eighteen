...
CREATE TABLE `age_gender` (
  `ag_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ag_id`)
...
LOCK TABLES `age_gender` WRITE;
/*!40000 ALTER TABLE `age_gender` DISABLE KEYS */;
INSERT INTO `age_gender` VALUES ('F1'),('F2'),('F3'),('F4'),('F5'),('F6'),('M1'),('M2'),('M3'),('M4'),('M5'),('M6');
/*!40000 ALTER TABLE `age_gender` ENABLE KEYS */;
UNLOCK TABLES;
